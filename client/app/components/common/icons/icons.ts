...
import { dashboardIconProps, searchIconProps, wishIconProps, authIconProps, starIconProps, clockIconProps, linkIconProps } from './constants'

export const SearchIcon = createIcon(searchIconProps)
export const WishIcon = createIcon(wishIconProps)
export const DashboardIcon = createIcon(dashboardIconProps)
